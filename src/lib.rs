...
//! | [`hybrid`] | `HybridModel`, `Projector`, `OLMoE` orchestration modules |
//! | [`tensor`] | Candle-free tensor helpers |
//! | [`transformer`] | Core transformer utilities |
...
pub use hybrid::{OLMoE, Projector};
