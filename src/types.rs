...
//!
//! * [`HybridConfig`] — everything needed to build a [`HybridModel`](crate::HybridModel).
...
/// Dimensionality of the dense embedding the [`Projector`](crate::hybrid::projector::Projector)
...
/// # Example
/// ```no_run
/// use corinth_canal::HybridConfig;
///
...
impl Default for HybridConfig {
    fn default() -> Self {
        Self {
            ...
            spine_endpoint: "ipc:///tmp/corinth_canal.ipc".into(),
        }
    }
}
...
/// Strategy used by the [`Projector`](crate::hybrid::projector::Projector) to convert
...
pub enum ProjectionMode {
    ...
    /// [`Projector::reset_membrane`](crate::hybrid::projector::Projector::reset_membrane).
    SpikingTernary,
}
...
/// The combined output of one [`HybridModel::forward`](crate::HybridModel::forward)
...
pub struct HybridOutput {
    ...
    // ── Projector layer ───────────────────────────────────────────────────────
    /// Dense embedding produced by the [`Projector`](crate::hybrid::projector::Projector)
...
/// [`HybridModel::train_step`](crate::HybridModel::train_step) call.
///
